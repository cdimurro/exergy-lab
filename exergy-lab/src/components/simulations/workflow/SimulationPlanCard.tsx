      ...
      <div className="border-b border-border">
        ...
        {expandedSections.methodology && (
          <div className="px-4 pb-4">
            <p className="text-sm text-foreground-subtle whitespace-pre-wrap">
              {plan.methodology}
            </p>
          </div>
        )}
            ...
            <div className="flex items-center gap-4 text-xs">
              {Object.entries(CATEGORY_COLORS).map(([cat, colors]) => (
                <div key={cat} className="flex items-center gap-1.5">
                  ...
                  <span className="text-foreground-subtle">{colors.label}</span>
                </div>
              ))}
            </div>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              {param.description && (
                                <span title={param.description}>
                                  <HelpCircle className="w-3.5 h-3.5 text-foreground-subtle cursor-help" />
                                </span>
                              )}
                            </div>
                            ...
                            {editingParam === param.id ? (
                              <>
                                <input
                                  ...
                                  className="w-24 h-8 px-2 rounded bg-page-background border border-border text-white text-sm"
                                  autoFocus
                                  onKeyDown={(e) => {
                              ...
                              <>
                                ...
                                {param.isEditable && (
                                  <button
                                    ...
                                    className="p-1 rounded hover:bg-primary/20 text-foreground-subtle hover:text-primary"
                                  >
            ...
            <div className="space-y-2">
              {plan.expectedOutputs.map((output, i) => (
                ...
                >
                  ...
                  <p className="text-xs text-foreground-subtle">{output.description}</p>
                </div>
              ))}
            </div>
          </div>
      ...
      <div className="p-4">
        {showChangeFeedback ? (
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm font-medium text-white">Request Changes</span>
              <button
            ...
            <ul className="text-xs text-foreground-subtle list-disc list-inside space-y-1">
            ...
            <textarea
              ...
              rows={3}
              className="w-full p-3 rounded-lg bg-page-background border border-border text-white text-sm resize-none
                         placeholder:text-foreground-subtle/50 focus:outline-none focus:ring-2 focus:ring-primary/50"
            />
          ...
          <button
            ...
            className="w-full py-2 px-4 rounded-lg border border-dashed border-border text-sm text-foreground-subtle
