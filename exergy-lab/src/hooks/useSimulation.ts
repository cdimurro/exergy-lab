...
export const TIER_INFO: TierCapabilities[] = [
  {
    ...
    description: 'Fast JavaScript-based calculations',
  ...
  {
    tier: 'browser',
    name: 'Tier 2: ML Surrogate',
    description: 'Machine learning surrogate models',
  ...
  {
    tier: 'cloud',
    name: 'Tier 3: Cloud HPC',
    description: 'Full physics simulation on GPU',
